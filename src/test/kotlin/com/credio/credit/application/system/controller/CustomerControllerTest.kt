...
class CustomerControllerTest {
    ...
    fun getById_ShouldNotGetCustomerByIdAndReturnStatusCodeBadRequest(){
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("$URL/$RANDOMID")
            ...
            .andExpect(MockMvcResultMatchers.jsonPath("$.cpf").value(""))
            .andExpect(MockMvcResultMatchers.jsonPath("$.income").value(0))
            .andExpect(MockMvcResultMatchers.jsonPath("$.email").value(""))
            .andExpect(MockMvcResultMatchers.jsonPath("$.zipCode").value(""))
            .andExpect(MockMvcResultMatchers.jsonPath("$.street").value(""))
